...
export const CartProvider: FC<Props> = ({ children }) => {
	...
	useEffect(() => {
		...
		if(Cookie.get("firName")){
			const shippingAddress={
				firName:  Cookie.get('firName') || '',
				lasName:  Cookie.get('lasName') || '',
	...
	const removeCartProduct = (product: ICartProduct) => {
		dispatch({ type: '[Cart] - Remove cart quantity', payload: product });
	};


	const updateAddress =(address:ShippingAddress)=>{
        Cookie.set('firName', address.firName);
		Cookie.set('lasName', address.lasName);
